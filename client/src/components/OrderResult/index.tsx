...
const CardContainer = ({ children }: Props) => (
  <div className="flex items-center justify-center w-full">
    <Card className="flex flex-col gap-4 p-7 md:p-14 justify-center items-center w-full max-w-[900px]">
      {children}
    </Card>
  </div>
)
...
const Actions = ({ children }: Props) => (
  <div className="flex flex-row flex-wrap gap-4 w-full max-w-[500px]">
    {children}
  </div>
)

export const OrderResult = Object.assign(Root, {
  Stepper,
  Card: CardContainer,
  Icon,
  Title,
